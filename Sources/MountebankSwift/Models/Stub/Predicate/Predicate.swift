...
///
/// [mbtest.dev/docs/api/predicates](https://www.mbtest.dev/docs/api/predicates)
public indirect enum Predicate: Equatable, Sendable {
    /// The request field matches the predicate
    /// [mbtest.dev/docs/api/predicates#predicates-equals](https://www.mbtest.dev/docs/api/predicates#predicates-equals)
    ...
    /// [mbtest.dev/docs/api/predicates#predicates-deepEquals](https://www.mbtest.dev/docs/api/predicates#predicates-deepEquals)
    case deepEquals(Request, PredicateParameters? = nil)

    /// The request field contains the predicate
    /// [mbtest.dev/docs/api/predicates#predicates-contains](https://www.mbtest.dev/docs/api/predicates#predicates-contains)
    case contains(Request, PredicateParameters? = nil)

    /// The request field starts with the predicate
    /// [mbtest.dev/docs/api/predicates#predicates-startsWith](https://www.mbtest.dev/docs/api/predicates#predicates-startsWith)
    case startsWith(Request, PredicateParameters? = nil)

    /// The request field ends with the predicate
    /// [mbtest.dev/docs/api/predicates#predicates-endsWith](https://www.mbtest.dev/docs/api/predicates#predicates-endsWith)
    ...
    /// [mbtest.dev/docs/api/predicates#predicates-matches](https://www.mbtest.dev/docs/api/predicates#predicates-matches)
    ...
    /// [mbtest.dev/docs/api/predicates#predicates-exists](https://www.mbtest.dev/docs/api/predicates#predicates-exists)
    case exists(Request, PredicateParameters? = nil)

    /// Inverts a predicate
    /// [mbtest.dev/docs/api/predicates#predicates-not](https://www.mbtest.dev/docs/api/predicates#predicates-not)
    case not(Predicate, PredicateParameters? = nil)

    /// Logically or's two predicates together
    /// [mbtest.dev/docs/api/predicates#predicates-or](https://www.mbtest.dev/docs/api/predicates#predicates-or)
    case or([Predicate], PredicateParameters? = nil)

    /// Logically and's two predicates together
    /// [mbtest.dev/docs/api/predicates#predicates-and](https://www.mbtest.dev/docs/api/predicates#predicates-and)
    ...
    /// [mbtest.dev/docs/api/predicates#predicates-inject](https://www.mbtest.dev/docs/api/predicates#predicates-inject)
    case inject(String)
}
